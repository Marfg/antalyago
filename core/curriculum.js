...
export const CURRICULUM = [
  { id:'c1', title:'Temel Kurallar', lessons:[
    ...
    { id:'l1_deg', title:'İlk Tahta Kontrolü ✓', steps:[
      ...
      { text:`<p>★★★ — <span class="term">△ A</span> ve <span class="term">□ B</span> ile işaretli iki gruptan hangisi daha fazla nefes noktasına sahip?</p>`, board:[{color:'B',x:6,y:2},{color:'B',x:5,y:3},{color:'B',x:3,y:6},{color:'B',x:5,y:6},{color:'B',x:6,y:5},{color:'B',x:7,y:5},{color:'B',x:7,y:6},{color:'B',x:3,y:7},{color:'B',x:4,y:7},{color:'B',x:5,y:7},{color:'W',x:2,y:6},{color:'W',x:3,y:5},{color:'W',x:4,y:5},{color:'W',x:5,y:5},{color:'W',x:4,y:6},{color:'W',x:6,y:6},{color:'W',x:6,y:7},{color:'W',x:7,y:7},{color:'W',x:2,y:7},{color:'W',x:8,y:7}], markers:[{x:3,y:7,type:'triangle'},{x:6,y:7,type:'square'}], showLiberties:true, auto:true, size:9, camera:CAM.overview, miniQuestion:{text:'Hangi grup daha fazla nefes noktasına sahip?',options:[{text:'△ A grubu (Siyah) daha fazla',correct:false,feedback:'Hayır. A grubu (Siyah) 3 nefes noktasında — B grubu daha fazla.'},{text:'□ B grubu (Beyaz) daha fazla',correct:true,feedback:'Doğru! B grubu (Beyaz) 4, A grubu (Siyah) 3 nefes noktasına sahip.'},{text:'İkisi eşit',correct:false,feedback:'Hayır. B grubu 4, A grubu 3 nefes noktası — eşit değil.'}]}, fb:{t:'△ ve □ işaretli grupların nefes noktalarını say.',c:'info'} },
    ]},
  ]},
