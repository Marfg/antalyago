...
export const CURRICULUM = [
  { id:'c1', title:'Temel Kurallar', lessons:[
    ...
    { id:'l1_deg', title:'İlk Tahta Kontrolü ✓', steps:[
      { text:`<p>★ <strong>Soru 1/10</strong> — Köşedeki taşın kaç nefes noktası var?</p>`, board:[{color:'W',x:0,y:0}], auto:true, showLiberties:true, size:9, camera:CAM.corner_tl, miniQuestion:{text:'Nefes sayısı?',options:[{text:'2',correct:true,feedback:'Doğru! Köşede 2 nefes noktası var.'},{text:'3',correct:false,feedback:'Hayır — köşede 2 yön açık.'},{text:'4',correct:false,feedback:'Hayır — ortada değil, köşede.'}]}, fb:{t:'Nefes noktalarını say.',c:'info'} },

      { text:`<p>★ <strong>Soru 2/10</strong> — Beyaz taşı yakala.</p>`, board:[{color:'W',x:0,y:0},{color:'B',x:1,y:0}], answer:{x:0,y:1}, turn:'black', size:9, camera:CAM.corner_tl, fb:{t:'Beyaz taşın son nefesini kapat.',c:'info'}, fb_ok:'Doğru! Yakaladın.', fb_err:'Beyaza dokunan tek boş noktayı bul.' },

      { text:`<p>★ <strong>Soru 3/10</strong> — Kenar taşının kaç nefesi var?</p>`, board:[{color:'W',x:4,y:0}], auto:true, showLiberties:true, size:9, camera:CAM.high, miniQuestion:{text:'Nefes sayısı?',options:[{text:'3',correct:true,feedback:'Evet! Kenarda 3 boş komşu.'},{text:'2',correct:false,feedback:'Hayır — kenar köşe değil, 3 açık yön var.'},{text:'4',correct:false,feedback:'Hayır — bir yön tahtanın dışına çıkıyor.'}]}, fb:{t:'Kenar taşının nefeslerini say.',c:'info'} },

      { text:`<p>★★ <strong>Soru 4/10</strong> — Beyaz atari'de mi?</p>`, board:[{color:'W',x:4,y:4},{color:'B',x:3,y:4},{color:'B',x:4,y:3},{color:'B',x:5,y:4}], auto:true, showLiberties:true, size:9, camera:CAM.center, miniQuestion:{text:'Beyaz atari\'de mi (tek nefes)?',options:[{text:'Evet, atari',correct:true,feedback:'Doğru! Yalnızca alt nokta boş — atari.'},{text:'Hayır, güvende',correct:false,feedback:'Hayır — üç komşu dolu, tek boş nokta kaldı.'}]}, fb:{t:'Nefes noktasını say.',c:'info'} },

      { text:`<p>★★ <strong>Soru 5/10</strong> — Atari'deki beyazı yakala.</p>`, board:[{color:'W',x:4,y:4},{color:'B',x:3,y:4},{color:'B',x:4,y:3},{color:'B',x:5,y:4}], answer:{x:4,y:5}, turn:'black', size:9, camera:CAM.center, fb:{t:'Son nefese oyna!',c:'info'}, fb_ok:'Yakaladın!', fb_err:'Beyaza dokunan tek boş noktayı bul.' },

      { text:`<p>★★ <strong>Soru 6/10</strong> — İşaretli noktaya siyah oynayabilir mi?</p>`, board:[{color:'W',x:3,y:4},{color:'W',x:5,y:4},{color:'W',x:4,y:3},{color:'W',x:4,y:5}], auto:true, size:9, camera:CAM.center, forbidden:[{x:4,y:4}], miniQuestion:{text:'Siyah X noktasına oynayabilir mi?',options:[{text:'Hayır, yasak',correct:true,feedback:'Doğru! Nefessiz kalır ve yakalama yok.'},{text:'Evet, serbest',correct:false,feedback:'Hayır — koysa hiç nefesi olmaz.'}]}, fb:{t:'Kırmızı X = yasak nokta.',c:'info'} },

      { text:`<p>★★ <strong>Soru 7/10</strong> — Beyaz hemen geri alabilir mi?</p>`, board:[{color:'B',x:4,y:3},{color:'B',x:3,y:4},{color:'B',x:5,y:4},{color:'B',x:4,y:5},{color:'W',x:3,y:5},{color:'W',x:5,y:5},{color:'W',x:4,y:6}], auto:true, size:9, camera:CAM.center, koPoint:{x:4,y:4}, miniQuestion:{text:'Beyaz kırmızı noktaya hemen oynayabilir mi?',options:[{text:'Hayır — ko',correct:true,feedback:'Doğru! Ko kuralı — önce başka hamle gerekli.'},{text:'Evet',correct:false,feedback:'Hayır! Bu ko — hemen geri dönemezsin.'}]}, fb:{t:'Ko = hemen geri alınamaz.',c:'info'} },

      { text:`<p>★★ <strong>Soru 8/10</strong> — Bu iki taşlı grubun toplam nefes sayısı?</p>`, board:[{color:'B',x:4,y:4},{color:'B',x:5,y:4}], auto:true, showLiberties:true, size:9, camera:CAM.center, miniQuestion:{text:'Grubun toplam nefes sayısı?',options:[{text:'6',correct:true,feedback:'Evet! Her taşın 3 dış nefesi, toplam 6.'},{text:'4',correct:false,feedback:'Hayır — iki taş birbirinden bağımsız nefes kazanır.'},{text:'8',correct:false,feedback:'Hayır — birbirine komşu nokta çift sayılmaz.'}]}, fb:{t:'Bağlı taşların nefesleri birleşir.',c:'info'} },

      { text:`<p>★★★ <strong>Soru 9/10</strong> — İki beyaz taşlı grubu yakala.</p>`, board:[{color:'W',x:4,y:4},{color:'W',x:4,y:5},{color:'B',x:3,y:4},{color:'B',x:5,y:4},{color:'B',x:4,y:3},{color:'B',x:3,y:5},{color:'B',x:5,y:5}], answer:{x:4,y:6}, turn:'black', size:9, camera:CAM.center, fb:{t:'Grubun son boş noktasını bul!',c:'info'}, fb_ok:'Mükemmel! İki taş birden yakalandı.', fb_err:'Grubun tek boş komşusunu bul.' },

      { text:`<p>★★★★ <strong>Soru 10/10</strong> — Köşe yasak görünüyor ama değil! Beyazları yakala.</p>`, board:[{color:'B',x:2,y:0},{color:'B',x:1,y:1},{color:'B',x:0,y:2},{color:'W',x:1,y:0},{color:'W',x:0,y:1}], answer:{x:0,y:0}, turn:'black', size:9, camera:CAM.corner_tl, fb:{t:'Görünüşte yasak — ama yakalayarak girebilirsin!',c:'info'}, fb_ok:'Harika! İstisna kuralını uyguladın — beyazları yakalayarak nefes açtın.', fb_err:'Köşeye (A9) git — beyaz taşları yakalarsın.' },
    ]},
  ]},
