...
test('RELEASE token "2026-08-25.2" — eski "2026-08-23.2/.3", "2026-08-24.1" ve "2026-08-25.1" query\'leri AKTİF graph\'ta KALMAMIŞ', () => {
  assert.equal(RELEASE, '2026-08-25.2');
  for (const rel of SCAN_FILES) {
    const src = read(rel);
    ...
    assert.ok(!src.includes('?v=2026-08-25.1'), `${rel}: eski (2026-08-25.1, production'da idi) release query'si HÂLÂ mevcut`);
  }
});
